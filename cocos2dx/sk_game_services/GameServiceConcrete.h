...
{
	virtual int num_level_ended_per_ad() override
	{
		return SK_NAMESPACE::game_services::num_level_ended_per_ad();
	}

	virtual int num_video_ad_per_interstitial() override
	{
		return SK_NAMESPACE::game_services::num_video_ad_per_interstitial();
	}
