...
namespace game_services
{
	...
	CC_DLL const char * android_store_developer_title();
#endif
	...
	CC_DLL int  num_level_ended_per_ad();
	CC_DLL int  num_video_ad_per_interstitial();
    ...
    CC_DLL bool is_unique_userid_authentication_required();
    CC_DLL bool is_unique_userid_authenticated();
    CC_DLL std::string get_unique_userid();
	...
	public:
		...
		virtual int num_level_ended_per_ad() = 0;
		virtual int num_video_ad_per_interstitial() = 0;
